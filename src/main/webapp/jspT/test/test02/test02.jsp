...
<body>
	...
	<div id="wrap">
		...
		<header class= "d-flex">
			<div class="logo d-flex align-items-center pl-4">
		...
		<nav class="main-manu">
			...
			<ul class="nav">
				<li class="nav-item"><a href="#" class="nav-link text-dark font-weight-bold">멜론챠트</a></li>
		...
		<footer>
			<hr>
			<div class="text-secondary small"> Copyright © Melong 2021</div>
		</footer>
